  ...
  return (
    <CheckboxPrimitive.Root
      ...
      <CheckboxPrimitive.Indicator
        ...
        <CheckIcon className="block stroke-3 group-data-indeterminate:hidden" />
